...
## How it works
![flow chart](./img/flow_chart.png | width=400)
...
![Programmer circuit](./img/sketch_aa.png | width=400)
...
![Thermometer circuit](./img/sketch_bb.png | width=400)
...
![ATtiny85 pinout](./img/attiny_pinout.jpg | width=600)
...
## Results
- Power consumption is very low. Avereage current is 200uA. ![Tested comsuption](./img/power_usage.png | width=400).
...
[Technoblogy consumption ratings](./img/power_reference.jpg | width=400)
